...
button.addEventListener("click", function(){
    ...
    ballArray.forEach(function(ball){
        ...
        if (temp <= 0){
            ...
            header.style.color = "black";
            ball.vx = 10 * temp + (Math.random() * -10);
            ball.vy = 10 * temp + (Math.random() * -10);
            ball.ay = 10;
            ball.ax = 10;
        }
        else{
            ...
            if(temp >= 80){
                ball.vx = (300 * Math.random()) + 400;
                ball.vy = (300 * Math.random()) + 400;
            }
            else if(temp >= 60){
                ball.vx = (300 * Math.random()) + 300;
                ball.vy = (300 * Math.random()) + 300;
            }
            else if(temp >= 40){
                ball.vx = (300 * Math.random()) + 200;
                ball.vy = (300 * Math.random()) + 200;
            }
            else if(temp >= 20){
                ball.vx = (300 * Math.random()) + 100;
                ball.vy = (300 * Math.random()) + 100;
            }
            else if(temp >= 0.01){
                ball.vx = (300 * Math.random());
                ball.vy = (300 * Math.random());
            }
    }});
});